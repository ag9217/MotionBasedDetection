function [variance, N] = varSpeedNframe(w, speed)
...
[dataGreenChannel,nFrames,groundTruth]=createMotion('noise','horizontal',speed);
%%%%%%%%%%% Path to the code %%%%%%%%%%%%%%%
...
pixels_per_degree = 5;                          %pixels_per_degree = #horiz. pixels in output / horizontal degrees (97.84)
