function RTC_Output=motionRTC(LMC_Output, Ts)
    ...
    On_Delayed_Channel(:,1:(end-2))=ON_Channel(:, 3:end);
    Off_Delayed_Channel(:,1:(end-2))=OFF_Channel(:, 3:end);
    ...
    ON_Filtered_Delayed(:,1:(end-2))=ON_Filtered(:,3:end);
    ...
    OFF_Filtered_Delayed(:,1:(end-2))=OFF_Filtered(:,3:end);
    ...
    [ON_Dlayed_Output,ONbuffer]=motionIIRFilter(b,a,ON_Spatial_Dead2,ONbuffer);
    ...
    [OFF_Dlayed_Output,OFFbuffer]=motionIIRFilter(b,a,OFF_Spatial_Dead2,OFFbuffer);
