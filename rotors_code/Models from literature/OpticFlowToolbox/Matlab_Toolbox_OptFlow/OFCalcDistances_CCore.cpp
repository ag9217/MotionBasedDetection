/****************************************************************************\
	Compute OFCalcDistances_CCore.cpp, Entry point of the OF_CCore. 
...
\**----------------------------------**/
    ...
    if(nrhs==4){ //Use a new OF_Core
        ...
        mexErrMsgTxt ("OFCalcDistances_CCore::2 or 4 input parameters are required");
    }
